      ...
      >
        ...
        >
          ...
          >
            ...
            <CopyText color={Color.Secondary2}>+43 664 1652141</CopyText>
            <CopyText color={Color.Secondary2}>office@pcode.at</CopyText>
          </Box>

          <div>
            <CopyText color={Color.Secondary2}>peter-behrens platz 2</CopyText>
            <CopyText color={Color.Secondary2}>4020 Linz, Austria</CopyText>
            <CopyText color={Color.Secondary2}>Axis Coworking loft</CopyText>
          </div>
        </Flex>
